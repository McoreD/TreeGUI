...
namespace ShareX.IndexerLib
{
    public class IndexerHtml : Indexer
    {
        ...
        {
            return $"Generated by <a href=\"https://getsharex.com/\">ShareX Directory Indexer</a> on {DateTime.UtcNow.ToString("yyyy-MM-dd 'at' HH:mm:ss 'UTC'")}";
        }
